...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { advisor_id: @slot.advisor_id, advisor_name: @slot.advisor_name, booked_by: @slot.booked_by, end_time: @slot.end_time, start_time: @slot.start_time, user_id: @slot.user_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { advisor_id: @slot.advisor_id, advisor_name: @slot.advisor_name, booked_by: @slot.booked_by, end_time: @slot.end_time, start_time: @slot.start_time, user_id: @slot.user_id } }
